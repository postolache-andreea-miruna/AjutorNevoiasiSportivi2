...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AjutorNevoiasiSportivi2.Entities.Role", b =>
                {
            ...
            modelBuilder.Entity("AjutorNevoiasiSportivi2.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("AjutorNevoiasiSportivi2.Entities.UserRole", b =>
                {
            ...
            modelBuilder.Entity("AjutorNevoiasiSportivi2.Entities.UserRole", b =>
                {
                    b.HasOne("AjutorNevoiasiSportivi2.Entities.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AjutorNevoiasiSportivi2.Entities.User", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("AjutorNevoiasiSportivi2.Entities.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AjutorNevoiasiSportivi2.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
